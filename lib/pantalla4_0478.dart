...
class Pantalla4_0478 extends StatelessWidget {
  const Pantalla4_0478({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Pantalla4 Galindo0478"),
        backgroundColor: Color(0xff606a8b),
      ),
      body: Center(
        child: Pantalla_0478(),
      ),
